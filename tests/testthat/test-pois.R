...
test_that("unweighted ranking on rank scale works", {
  unweight_rank <- ClusterRank(poisData$lbw,poisData$births,datatype = "poisson", row_names=poisData$county, scale=rank, weighted=FALSE)
...
test_that("weighted ranking on rank scale works", {
  weight_rank <- ClusterRank(poisData$lbw,poisData$births, datatype = "poisson", row_names=poisData$county, scale=rank, weighted=TRUE)
